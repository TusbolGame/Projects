...
class _CameraHomeScreenState extends State<CameraHomeScreen> {
  ...
  void onVideoRecordButtonPressed() {
    ...
    session.audioPlayer.play(session.feed_url);
    session.audioPlayer.setReleaseMode(ReleaseMode.LOOP);
  ...
  Future<String> startVideoRecording() async {
    ...
    final String dirPath = '${extDir.path}/FlutterDevs/Camera/Videos';
