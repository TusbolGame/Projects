import 'package:MiniTikTok/widgets/challenge/challenge_controls.dart';
                ...
                if(video_url.contains('youtube'))
                {
                    ...
                    return Container(
                        ...
                        child: Stack(
                            ...
                            children: <Widget>[YoutubeVideoPlayer(video_url, yController)],
                        ),
                    );
                }
                else{
                    currentIndex = position;
                    vController = new VideoPlayerController.network(
                        video_url);
                    return Container(
                        color: Colors.black,
                        child: Stack(
                            children: <Widget>[AppVideoPlayer(video_url, vController)],
