...
public class RegisterSystem : MonoBehaviour {
	...
	public void checkBanned(){
		...
		if (nameRequierd && userName.text.Length < 1) {
			WarningMSG.text = "You have to input Your Username";
	...
	public void CreateAccount(){
		...
		var user_table = ds.createUser(userName.text, Password.text, Int32.Parse(Age.text));
