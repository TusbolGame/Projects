...
<script>
  import Button, {Group, GroupItem, Label, Icon} from '@smui/button/bare';
  import Menu from '@smui/menu/bare';
  import List, {Item, Separator, Text} from '@smui/list/bare';
...
<style>
	...
	@import url(https://unpkg.com/@smui/button@latest/bare.css);
	@import url(https://unpkg.com/@smui/menu@latest/bare.css);
	@import url(https://unpkg.com/@smui/list@latest/bare.css);
