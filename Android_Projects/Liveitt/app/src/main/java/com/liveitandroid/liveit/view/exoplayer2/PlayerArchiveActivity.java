...
public class PlayerArchiveActivity extends Activity implements OnClickListener, VisibilityListener {
    ...
    private static final Map<Integer, Integer> RESIZE_MODE = Collections.unmodifiableMap(new C19441());
    ...
    static class C19441 extends HashMap<Integer, Integer> {
        C19441() {
    ...
    class C19452 implements MediaSourceFactory {
        C19452() {
        }
    ...
    private MediaSource createAdsMediaSource(MediaSource mediaSource, Uri adTagUri) throws Exception {
        ...
        return new AdsMediaSource(mediaSource, new C19452(), this.adsLoader, this.adUiViewGroup, this.mainHandler, this.eventLogger);
    }
