...
public class VodMenuFilmesAPP4SerActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.menu_todos_vod:
                i = new Intent(context, VodMenuFilmesAPP4SerSelectActivity.class);
            ...
            case R.id.menu_favoritos_vod:
                ...
                i.putExtra("selyear", "");
                i.putExtra("selnome", "Minhas Séries Favoritas");
                startActivity(i);
                overridePendingTransition(R.anim.fade_out, R.anim.fade_in);
                return;
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (!serachWord_Txt.equals("")) {
                                    Intent i = new Intent(context, VodMenuFilmesAPP4SerSelectActivity.class);
