...
public class VodAdapterAppEpisodios extends Adapter<VodAdapterAppEpisodios.MyViewHolder> {
    ...
    public VodAdapterAppEpisodios(List<ListMoviesSetterGetter> vodCategories, Context context) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (TextUtils.isEmpty(text)) {
                    filterList.addAll(VodAdapterAppEpisodios.this.completeList);
                } else {
