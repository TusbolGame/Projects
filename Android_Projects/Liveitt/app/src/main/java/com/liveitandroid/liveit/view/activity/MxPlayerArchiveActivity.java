...
public class MxPlayerArchiveActivity extends AppCompatActivity {
    ...
    public void mxPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C16401());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C16412());
