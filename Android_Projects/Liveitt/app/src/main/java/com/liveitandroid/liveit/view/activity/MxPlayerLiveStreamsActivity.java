...
public class MxPlayerLiveStreamsActivity extends AppCompatActivity {
    ...
    public void mxPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C16421());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C16432());
