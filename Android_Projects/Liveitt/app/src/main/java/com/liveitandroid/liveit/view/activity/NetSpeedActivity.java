...
public class NetSpeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mStartRX == TrafficStats.UNSUPPORTED) {
            ...
            alert.setTitle("Network Connection Failed");
        ...
        double currentValue = (double)(TrafficStats.getTotalRxBytes()- mStartRX) / 1000D;
        ...
        circularGauge.axis(0)
                ...
                .sweepAngle(300)
                .width(2)
                .ticks("{ type: 'line', length: 2, position: 'outside' }");
        ...
        circularGauge.label(0)
                .text("<span style=\"font-size: 25; text-align:center\">Speed</span>")
                .useHtml(true)
        ...
        circularGauge.label(1)
                .text("<span style=\"font-size: 20\">" + String.format("%.2f", currentValue) + "</span>")
                .useHtml(true)
                .hAlign(HAlign.CENTER);
        circularGauge.label(1)
                .anchor(Anchor.CENTER_TOP)
    ...
    private final Runnable mRunnable = new Runnable() {
        public void run() {
            ...
            double currentValue = (double)(rxBytes) / 2000D;
            circularGauge.data(new SingleValueDataSet(new Double[] { currentValue }));
            circularGauge.label(1)
                    .text("<span style=\"font-size: 20\">" + String.format("%.2f", currentValue) + "</span>")
                    .useHtml(true)
