...
import com.liveitandroid.liveit.view.fragment.SubTVArchiveFragment;
...
public class SubTVArchiveCategoriesAdapter extends FragmentPagerAdapter {
    ...
    public SubTVArchiveCategoriesAdapter(List<String> liveStreamCategories, ArrayList<XMLTVProgrammePojo> liveStreamsEpgCallback, String opened_stream_id, String opened_num, String opened_channel_name, String opened_channel_icon, String opened_channel_id, String opened_channel_duration, FragmentManager fm, Context context) {
        super(fm);
