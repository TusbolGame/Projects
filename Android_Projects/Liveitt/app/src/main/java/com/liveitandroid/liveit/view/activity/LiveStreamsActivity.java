...
import com.liveitandroid.liveit.view.adapter.LiveStreamCategoriesAdapter;
import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Iterator;
import java.util.concurrent.TimeUnit;

public class LiveStreamsActivity extends AppCompatActivity implements OnClickListener {
    ...
    class C16241 implements OnPageChangeListener {
        C16241() {
        }
    ...
    private void setUpDatabaseResults() {
        if (this.context != null) {
            ...
            if (this.liveListDetailAvailable != null && this.viewpager != null && this.slidingTabs != null) {
                ...
                this.viewpager.setOnPageChangeListener(new C16241());
            }
        }
    }
