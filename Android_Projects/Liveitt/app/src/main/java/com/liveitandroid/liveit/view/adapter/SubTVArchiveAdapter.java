...
//    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int listPosition) {
        if (this.context != null) {
            ...
            Long epgDateToTimestamp = Long.valueOf(com.liveitandroid.liveit.miscelleneious.common.Utils.epgTimeConverter(getStart));
            Long epgDateToTimestampStop = Long.valueOf(com.liveitandroid.liveit.miscelleneious.common.Utils.epgTimeConverter(getStop));
            ...
            holder.rl_archive_layout.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    com.liveitandroid.liveit.miscelleneious.common.Utils.playWithPlayerArchive(SubTVArchiveAdapter.this.context, selectedPlayer, Integer.parseInt(streamID), SubTVArchiveAdapter.this.streamNum, SubTVArchiveAdapter.this.streamName, SubTVArchiveAdapter.this.streamChannelID, SubTVArchiveAdapter.this.streamIcon, getStartFormatedTime, SubTVArchiveAdapter.this.streamChannelDuration, getStopTime);
                }
            });
