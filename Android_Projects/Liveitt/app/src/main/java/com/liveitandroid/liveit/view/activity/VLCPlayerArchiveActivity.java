...
public class VLCPlayerArchiveActivity extends AppCompatActivity {
    ...
    public void vlcPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C17761());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C17772());
