...
import com.liveitandroid.liveit.view.fragment.NewEPGFragment;
import com.liveitandroid.liveit.model.LiveStreamCategoryIdDBModel;
import com.liveitandroid.liveit.view.fragment.NewEPGFragment;
...
public class NewEPGCategoriesAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        return NewEPGFragment.newInstance(this.LiveStreamCategoriesIds[position], this.liveStreamCategoriesNames[position]);
    }
