...
public class NSTPlayerSeriesActivity extends Activity implements OnClickListener {
    ...
    public static class Config implements Parcelable {
        public static final Creator<Config> CREATOR = new C20531();
        ...
        static class C20531 implements Creator<Config> {
            C20531() {
            }
    ...
    public static com.liveitandroid.liveit.view.nstplayer.NSTPlayerArchiveActivity.Config configPlayer(Activity activity) {
        return new com.liveitandroid.liveit.view.nstplayer.NSTPlayerArchiveActivity.Config(activity);
    }
