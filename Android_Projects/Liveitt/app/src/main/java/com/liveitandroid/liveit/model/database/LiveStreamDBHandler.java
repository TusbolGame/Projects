...
public class LiveStreamDBHandler extends SQLiteOpenHelper {
    ...
    public void addMovieCategoriesPlayer(List<VodCategoriesCallback> liveStreamCategoryIdDBModel) {
        try {
            SQLiteDatabase addMoviesCategories = getWritableDatabase();
            addMoviesCategories.beginTransaction();
            ContentValues values = new ContentValues();
            ...
            if (totalMovie != 0) {
                for (int i = 0; i < totalMovie; i++) {
                    values.put(KEY_CATEGORY_ID_MOVIE, ((VodCategoriesCallback) liveStreamCategoryIdDBModel.get(i)).getCategoryId());
                    values.put(KEY_CATEGORY_NAME_MOVIE, ((VodCategoriesCallback) liveStreamCategoryIdDBModel.get(i)).getCategoryName());
                    values.put(KEY_ID_PARENT_ID, ((VodCategoriesCallback) liveStreamCategoryIdDBModel.get(i)).getParentId());
                    addMoviesCategories.insert(TABLE_IPTV_MOVIE_CATEGORY, null, values);
                }
            }
            addMoviesCategories.setTransactionSuccessful();
    ...
    public void addAllAvailableVodPlayer(List<VodStreamsCallback> availableChanelsList) {
        try {
            SQLiteDatabase addChannel = getWritableDatabase();
            addChannel.beginTransaction();
            ContentValues values = new ContentValues();
            int totalMovie = availableChanelsList.size();
            if (totalMovie != 0) {
                for (int i = 0; i < totalMovie; i++) {
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getNum() != null) {
                        values.put(KEY_NUM_LIVE_STREAMS, String.valueOf(((VodStreamsCallback) availableChanelsList.get(i)).getNum()));
                    } else {
                        values.put(KEY_NUM_LIVE_STREAMS, "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getName() != null) {
                        values.put("name", ((VodStreamsCallback) availableChanelsList.get(i)).getName());
                    } else {
                        values.put("name", "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getStreamType() != null) {
                        values.put(KEY_STRESM_TYPE, ((VodStreamsCallback) availableChanelsList.get(i)).getStreamType());
                    } else {
                        values.put(KEY_STRESM_TYPE, "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getStreamId() != null) {
                        values.put(KEY_STREAM_ID, ((VodStreamsCallback) availableChanelsList.get(i)).getStreamId());
                    } else {
                        values.put(KEY_STREAM_ID, "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getStreamIcon() != null) {
                        values.put(KEY_STREAM_ICON, ((VodStreamsCallback) availableChanelsList.get(i)).getStreamIcon());
                    } else {
                        values.put(KEY_STREAM_ICON, "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getAdded() != null) {
                        values.put("added", ((VodStreamsCallback) availableChanelsList.get(i)).getAdded());
                    } else {
                        values.put("added", "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getCategoryId() != null) {
                        values.put("categoryID", ((VodStreamsCallback) availableChanelsList.get(i)).getCategoryId());
                    } else {
                        values.put("categoryID", "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getCustomSid() != null) {
                        values.put(KEY_CUSTOMER_SID, ((VodStreamsCallback) availableChanelsList.get(i)).getCustomSid());
                    } else {
                        values.put(KEY_CUSTOMER_SID, "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getDirectSource() != null) {
                        values.put(KEY_DIRECT_SOURCE, ((VodStreamsCallback) availableChanelsList.get(i)).getDirectSource());
                    } else {
                        values.put(KEY_DIRECT_SOURCE, "");
                    }
                    if (((VodStreamsCallback) availableChanelsList.get(i)).getContainerExtension() != null) {
                        values.put(KEY_AVAIL_CHANNEL_CONTAINER_EXTENSION, String.valueOf(((VodStreamsCallback) availableChanelsList.get(i)).getContainerExtension()));
                    } else {
    ...
    public void addAllAvailableChannelPlayer(List<LiveStreamsCallback> availableChanelsList) {
        try {
            SQLiteDatabase addChannel = getWritableDatabase();
            addChannel.beginTransaction();
            ContentValues values = new ContentValues();
            ...
            if (totalMovie != 0) {
                for (int i = 0; i < totalMovie; i++) {
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getNum() != null) {
                        values.put(KEY_NUM_LIVE_STREAMS, String.valueOf(((LiveStreamsCallback) availableChanelsList.get(i)).getNum()));
                    } else {
                        values.put(KEY_NUM_LIVE_STREAMS, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getName() != null) {
                        values.put("name", ((LiveStreamsCallback) availableChanelsList.get(i)).getName());
                    } else {
                        values.put("name", "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getStreamType() != null) {
                        values.put(KEY_STRESM_TYPE, ((LiveStreamsCallback) availableChanelsList.get(i)).getStreamType());
                    } else {
                        values.put(KEY_STRESM_TYPE, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getStreamId() != null) {
                        values.put(KEY_STREAM_ID, ((LiveStreamsCallback) availableChanelsList.get(i)).getStreamId());
                    } else {
                        values.put(KEY_STREAM_ID, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getStreamIcon() != null) {
                        values.put(KEY_STREAM_ICON, ((LiveStreamsCallback) availableChanelsList.get(i)).getStreamIcon());
                    } else {
                        values.put(KEY_STREAM_ICON, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getEpgChannelId() != null) {
                        values.put(KEY_EPG_CHANNEL_ID, ((LiveStreamsCallback) availableChanelsList.get(i)).getEpgChannelId());
                    } else {
                        values.put(KEY_EPG_CHANNEL_ID, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getAdded() != null) {
                        values.put("added", ((LiveStreamsCallback) availableChanelsList.get(i)).getAdded());
                    } else {
                        values.put("added", "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getCategoryId() != null) {
                        values.put("categoryID", ((LiveStreamsCallback) availableChanelsList.get(i)).getCategoryId());
                    } else {
                        values.put("categoryID", "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getCustomSid() != null) {
                        values.put(KEY_CUSTOMER_SID, ((LiveStreamsCallback) availableChanelsList.get(i)).getCustomSid());
                    } else {
                        values.put(KEY_CUSTOMER_SID, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getTvArchive() != null) {
                        values.put(KEY_TV_ARCHIVE, ((LiveStreamsCallback) availableChanelsList.get(i)).getTvArchive());
                    } else {
                        values.put(KEY_TV_ARCHIVE, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getDirectSource() != null) {
                        values.put(KEY_DIRECT_SOURCE, ((LiveStreamsCallback) availableChanelsList.get(i)).getDirectSource());
                    } else {
                        values.put(KEY_DIRECT_SOURCE, "");
                    }
                    if (((LiveStreamsCallback) availableChanelsList.get(i)).getTvArchiveDuration() != null) {
                        values.put(KEY_TV_ARCHIVE_DURATION, ((LiveStreamsCallback) availableChanelsList.get(i)).getTvArchiveDuration());
                    } else {
    ...
    public int getSubCatMovieCount(String categoryID, String type) {
        try {
            Cursor cursor = getReadableDatabase().rawQuery("SELECT  COUNT(*) FROM iptv_live_streams WHERE stream_type='" + type + "' AND " + "categoryID" + "='" + categoryID + "'", null);
            cursor.moveToFirst();
            int count = cursor.getInt(0);
            cursor.close();
            return count;
    ...
    public ArrayList<LiveStreamsDBModel> getFirstchannelNum(String catID) {
        ...
        String selectQuery = "";
        if (catID.equals(AppConst.PASSWORD_UNSET)) {
            if (sort.equals(AppConst.PASSWORD_UNSET)) {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' LIMIT 1";
            } else if (sort.equals("1")) {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' ORDER BY added DESC LIMIT 1";
            } else if (sort.equals("3")) {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' ORDER BY name DESC LIMIT 1";
            } else {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' ORDER BY name ASC LIMIT 1";
            }
        } else if (!catID.equals("-1")) {
            if (sort.equals(AppConst.PASSWORD_UNSET)) {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' AND categoryID ='" + catID + "' LIMIT 1";
            } else if (sort.equals("1")) {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' AND categoryID ='" + catID + "' ORDER BY " + "added" + " DESC LIMIT 1";
            } else if (sort.equals("3")) {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' AND categoryID ='" + catID + "' ORDER BY " + "name" + " DESC LIMIT 1";
            } else {
                selectQuery = "SELECT  * FROM iptv_live_streams WHERE stream_type LIKE '%live%' AND categoryID ='" + catID + "' ORDER BY " + "name" + " ASC LIMIT 1";
            }
        }
        try {
    ...
    public ArrayList<LiveStreamsDBModel> getCatDetailsWithStreamID(int streamID) {
        ArrayList<LiveStreamsDBModel> liveStreamsList = new ArrayList();
        String selectQuery = "";
        try {
            Cursor cursor = getReadableDatabase().rawQuery("SELECT  * FROM iptv_live_streams WHERE stream_type='live' AND stream_id='" + streamID + "'", null);
            if (cursor.moveToFirst()) {
                do {
                    LiveStreamsDBModel liveStreamsDBModel = new LiveStreamsDBModel();
                    liveStreamsDBModel.setIdAuto(Integer.parseInt(cursor.getString(0)));
    ...
    public ArrayList<LiveStreamsDBModel> getAllLiveStreasWithCategoryId(String cateogryId, String type) {
        String sort;
        if (type == KEY_AVAIL_CHANNEL_LIVE) {
            sort = AppConst.PASSWORD_UNSET;
        } else {
            sort = this.context.getSharedPreferences(AppConst.LOGIN_PREF_SORT, 0).getString(AppConst.LOGIN_PREF_SORT, "");
        }
        ArrayList<LiveStreamsDBModel> liveStreamsList;
        String selectQuery;
        Cursor cursor;
    ...
    public void addLiveCategoriesPlayer(List<LiveStreamCategoriesCallback> liveStreamCategoryIdDBModel) {
        try {
            SQLiteDatabase addLiveCategories = getWritableDatabase();
            addLiveCategories.beginTransaction();
            ContentValues values = new ContentValues();
            ...
            if (totalLive != 0) {
                for (int i = 0; i < totalLive; i++) {
                    values.put(KEY_CATEGORY_ID_LIVE, ((LiveStreamCategoriesCallback) liveStreamCategoryIdDBModel.get(i)).getCategoryId());
                    values.put(KEY_CATEGORY_NAME_LIVE, ((LiveStreamCategoriesCallback) liveStreamCategoryIdDBModel.get(i)).getCategoryName());
                    values.put(KEY_ID_PARENT_ID, ((LiveStreamCategoriesCallback) liveStreamCategoryIdDBModel.get(i)).getParentId());
                    addLiveCategories.insert(TABLE_IPTV_LIVE_CATEGORY, null, values);
                }
            }
            addLiveCategories.setTransactionSuccessful();
