...
public class VLCPlayerLiveStreamsActivity extends AppCompatActivity {
    ...
    public void vlcPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new C17781());
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new C17792());
