...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="http://design.pinesucceed.com/the_wizard_html/images/favicon.png" />
		<script src="js/jquery-3.js"></script>
		<script src="js/popper.js"></script>
		<script src="js/bootstrap.js"></script>
		<script>
		function openNav() {
		    document.getElementById("bs-example-navbar-collapse-1").style.right = "";
