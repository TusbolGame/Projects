	...
	<div class="container">
		<nav class="breadcrumb_area" aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">NCAA BASKETBALL</li>
			</ol>
		</nav>
		<div class="ncaa_area">
			...
			<div class="col-12 margin-0 serach-btn d-inline-flex w-100 ">
				<button id="dailyalgorithm" type="button" class="margin0 submit_btn btn">Daily Algorithm</button>
			</div>
		</div>
	</div>
</section>
<script>
$('#dailyalgorithm').on('click', function() {	
	var request = new XMLHttpRequest();
	request.open('GET', 'restapi/ncaabreport', true);
	request.setRequestHeader('Content-Type', 'application/vnd.ms-excel');
	request.setRequestHeader('Accept', 'vnd.ms-excel');
	request.responseType = 'blob';
	request.timeout = 45000; // Set timeout to 4 seconds (4000 milliseconds)
