 ...
 * 
 */
package com.wooanalytics.dao.cache;
...
public class ReportCacheSingleton implements Runnable {
	...
	static {
		...
		try {
			...
			REPORT_CACHE.vips.getHttpClientWrapper().setupHttpClient("None");
		} catch (Exception e) {
	 ...
	 * @return the vig
	 */
	public List<VegasInsiderGame> getVig() {
		return vig;
	}

	/**
	 * @param vig the vig to set
	 */
	public void setVig(List<VegasInsiderGame> vig) {
		this.vig = vig;
	}
	...
	/**
	 * @return the masseySpreads
	 */
	public List<MasseyRatingsData> getMasseySpreads() {
		return masseySpreads;
	}

	/**
	 * @param masseySpreads the masseySpreads to set
	 */
	public void setMasseySpreads(List<MasseyRatingsData> masseySpreads) {
		this.masseySpreads = masseySpreads;
	}
	...
	private void updateCache() {
		while (true) {
			try {
				...
				REPORT_CACHE.vig = vips.getNcaabScheduleNextTwoDays();
				REPORT_CACHE.lkpd = kps.getNcaabScheduleNextTwoDays();
				REPORT_CACHE.nextdaykpd = kps.getNcaabScheduleNextDay();
				REPORT_CACHE.masseySpreads = masseyRatingsSite.getNcaabScheduleNextTwoDays();
