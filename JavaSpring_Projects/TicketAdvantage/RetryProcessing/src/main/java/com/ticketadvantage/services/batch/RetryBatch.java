...
@WebListener
@Service
public class RetryBatch implements Runnable, ServletContextListener {
	private static final Logger LOGGER = Logger.getLogger(RetryBatch.class);
	...
	public static void main(String[] args) {
		...
		try {
			final RetryBatch retryBatch = new RetryBatch();
