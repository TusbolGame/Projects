...
public class BaseScrapper implements Serializable {
	...
	@Column(name = "sendtextforgame", unique = false, nullable = true)
	@XmlElement(nillable=true)
	private Boolean sendtextforgame = new Boolean(false);
	...
	/**
	 * @return the sendtextforgame
	 */
	public Boolean getSendtextforgame() {
		return sendtextforgame;
	}

	/**
	 * @param sendtextforgame the sendtextforgame to set
	 */
	public void setSendtextforgame(Boolean sendtextforgame) {
		this.sendtextforgame = sendtextforgame;
	}
	...
	public String toString() {
		return "BaseScrapper [id=" + id + ", scrappername=" + scrappername + ", userid=" + userid
				...
				+ ", bestprice=" + bestprice + ", sendtextforaccount=" + sendtextforaccount + ", sendtextforgame="
				+ sendtextforgame + ", onoff=" + onoff + ", gameonoff=" + gameonoff + ", firstonoff=" + firstonoff
				+ ", secondonoff=" + secondonoff + ", thirdonoff=" + thirdonoff + ", nflspreadonoff=" + nflspreadonoff
				+ ", nfltotalonoff=" + nfltotalonoff + ", nflmlonoff=" + nflmlonoff + ", ncaafspreadonoff="
				+ ncaafspreadonoff + ", ncaaftotalonoff=" + ncaaftotalonoff + ", ncaafmlonoff=" + ncaafmlonoff
				+ ", nbaspreadonoff=" + nbaspreadonoff + ", nbatotalonoff=" + nbatotalonoff + ", nbamlonoff="
				+ nbamlonoff + ", ncaabspreadonoff=" + ncaabspreadonoff + ", ncaabtotalonoff=" + ncaabtotalonoff
				+ ", ncaabmlonoff=" + ncaabmlonoff + ", wnbaspreadonoff=" + wnbaspreadonoff + ", wnbatotalonoff="
				+ wnbatotalonoff + ", wnbamlonoff=" + wnbamlonoff + ", nhlspreadonoff=" + nhlspreadonoff
				+ ", nhltotalonoff=" + nhltotalonoff + ", nhlmlonoff=" + nhlmlonoff + ", mlbspreadonoff="
				+ mlbspreadonoff + ", mlbtotalonoff=" + mlbtotalonoff + ", mlbmlonoff=" + mlbmlonoff
