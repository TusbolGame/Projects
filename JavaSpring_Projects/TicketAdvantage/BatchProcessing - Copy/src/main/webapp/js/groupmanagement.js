	...
	$.fn.getGroup = function(id) {
		$.fn.serviceCall('GET', '', 'restapi/group/id/' + id, 15000, function(data) {
        	var selectedString = '';
        	selectedList = [];
    			...
    			receive: function(event, ui) {
    				...
    				$("#account-list li").each(function(index) {
    					if (i === end_pos) {
    						...
    						// Call Delete
    						$.fn.serviceCall('DELETE', '{"groupid":"' + groupId + '","accountid":"' +  $(this).attr('id') + '"}', 'restapi/groupaccount', 15000, function(data) {
    			            	log('Success');
    						});
    					}
    					i++;
    			...
    			receive: function(event, ui) {
    				...
    				$("#sortable li").each(function(index) {
    					if (i === end_pos) {
    						...
    						$.fn.serviceCall('PUT', '{"groupid":"' + groupId + '","accountid":"' +  $(this).attr('id') + '"}', 'restapi/groupaccount', 15000, function(data) {
    			            	log('Success');
    						});
    					}
    					i++;
