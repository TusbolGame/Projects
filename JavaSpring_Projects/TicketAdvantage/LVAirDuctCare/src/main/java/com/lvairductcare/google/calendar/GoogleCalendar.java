 ...
 * 
 */
package com.lvairductcare.google.calendar;
...
public class GoogleCalendar {
	...
	private static final String APPLICATION_NAME = "LVAirDuctCare";
	...
	public static void main(String... args) throws IOException, GeneralSecurityException {
		...
		service.events().insert("", newEvent);
	...
	private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
		// Load client secrets.
		final InputStream in = GoogleCalendar.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
		if (in == null) {
