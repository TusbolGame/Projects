    		...
    		<div class="container">
	      	...
	      	<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12 aos-init" data-aos="fade-up" data-aos-duration="600">
					<div class="services">
						<div class="service_img"><img src="images/service_img1.png" alt=""></div>
				...
				<div class="services">
					<div class="service_img"><img src="images/service_img2.png" alt=""></div>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 aos-init" data-aos="fade-up" data-aos-duration="1500">
					<div class="services">
						<div class="service_img"><img src="images/service_img4.png" alt=""></div>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 aos-init" data-aos="fade-up" data-aos-duration="1200">
					<div class="services">
						<div class="service_img"><img src="images/service_img3.png" alt=""></div>
				...
				<div class="tile">
					...
					<div class="card-body">
						<h1 class="card-title pricing-card-title">
							$150 <small class="text-muted"><spring:message code="peraircondition" text="default"/></small>
						</h1>
						<ul class="list-unstyled mt-3 mb-4">
							<li><spring:message code="dirtyairductsmessage" text="default"/></li>
						</ul>
						<button type="button" class="btn btn-lg btn-block"><spring:message code="getstarted" text="default"/></button>
					</div>
				</div>
			</div>
			<div class="item">
		...
		<div class="container">
			...
			<div class="row aos-init" data-aos="fade-up" data-aos-duration="600">
				<div class="col-md-6 col-sm-12 col-12 contact_left">
					<img src="images/booking_img.jpg" alt="">
				</div>
