 ...
 *
 */
public class BetPantherTDSportsParser extends TDSportsParser {
	private static final Logger LOGGER = Logger.getLogger(BetPantherTDSportsParser.class);
	 ...
	 * Constructor
	 */
	public BetPantherTDSportsParser() {
		super();
	}
	...
	public Map<String, String> parseMenu(String xhtml, String[] type, String[] sport) throws BatchException {
		...
		map = findMenu(doc.select("#content center table tbody tr td table tbody tr"), map, type, sport, "td span b", "td input");
