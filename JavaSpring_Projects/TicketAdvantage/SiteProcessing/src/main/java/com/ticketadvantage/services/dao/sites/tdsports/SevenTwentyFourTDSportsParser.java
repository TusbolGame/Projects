 ...
 *
 */
public class SevenTwentyFourTDSportsParser extends TDSportsParser {
	private static final Logger LOGGER = Logger.getLogger(SevenTwentyFourTDSportsParser.class);
	private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("MMM dd yyyy hh:mm a z");

	/**
	 * Constructor
	 */
	public SevenTwentyFourTDSportsParser() {
		super();
	}
	...
	public Map<String, String> parseMenu(String xhtml, String[] type, String[] sport) throws BatchException {
		...
		map = findMenu(doc.select(".TBLeagueLinks tbody tr td table tbody tr"), map, type, sport, "td span b", "td input");
