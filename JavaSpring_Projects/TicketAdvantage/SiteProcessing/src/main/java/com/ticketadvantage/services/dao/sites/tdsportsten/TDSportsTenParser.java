 ...
 *
 */
public class TDSportsTenParser extends TDSportsParser {
	private static final Logger LOGGER = Logger.getLogger(TDSportsTenParser.class);

	/**
	 * Constructor
	 */
	public TDSportsTenParser() {
		super();
	}
	...
	public static void main(String[] args) {
		try {
			final TDSportsTenParser names777TDSportsParser = new TDSportsTenParser();
...
//			LOGGER.debug("TicketNumber: " + ticketNumber);
	...
	public Map<String, String> parseMenu(String xhtml, String[] type, String[] sport) throws BatchException {
		...
		map = findMenu(doc.select(".menu div div table tbody tr"), map, type, sport, "td a", "td input");
	...
	public <TDSportsEventPackage> List<TDSportsEventPackage> parseGames(String xhtml, String type, Map<String, String> inputFields) throws BatchException {
		...
		// playthedog.net
		Elements elements = doc.select("#bet_txtcont center table tbody tr");
