 ...
 *
 */
public class Bet504TDSportsParser extends TDSportsParser {
	private static final Logger LOGGER = Logger.getLogger(Bet504TDSportsParser.class);
	...
	public static void main(String[] args) {
		try {
			final Bet504TDSportsParser bet504TDSportsParser = new Bet504TDSportsParser();
