 ...
 *
 */
public class MyWagerLiveTDSportsParser extends TDSportsParser {
	private static final Logger LOGGER = Logger.getLogger(MyWagerLiveTDSportsParser.class);
	 ...
	 * Constructor
	 */
	public MyWagerLiveTDSportsParser() {
		super();
	}
