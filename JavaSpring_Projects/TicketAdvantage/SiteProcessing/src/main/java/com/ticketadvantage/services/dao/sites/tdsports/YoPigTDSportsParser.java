 ...
 *
 */
public class YoPigTDSportsParser extends TDSportsParser {
	private static final Logger LOGGER = Logger.getLogger(YoPigTDSportsParser.class);
	private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("MMM dd yyyy hh:mm a z");

	/**
	 * Constructor
	 */
	public YoPigTDSportsParser() {
		super();
	}
	...
	public Map<String, String> parseMenu(String xhtml, String[] type, String[] sport) throws BatchException {
		...
		map = findMenu(doc.select("#TableLeague div div"), map, type, sport, "span", "input");
