 ...
 *
 */
public class Ebets247TDSportsProcessSite extends TDSportsProcessSite {
	private static final Logger LOGGER = Logger.getLogger(Ebets247TDSportsProcessSite.class);
	protected BetBigCityTDSportsParser TDP = new BetBigCityTDSportsParser();

	/**
	 * 
	 */
	public Ebets247TDSportsProcessSite(String host, String username, String password, boolean isMobile, boolean showRequestResponse) {
		super("Ebets247TDSports", host, username, password, isMobile, showRequestResponse);
		LOGGER.info("Entering Ebets247TDSportsProcessSite()");
		...
		LOGGER.info("Exiting Ebets247TDSportsProcessSite()");
	}
	 ...
	 * @param password
	 */
	public Ebets247TDSportsProcessSite(String accountSoftware, String host, String username, String password, boolean isMobile, boolean showRequestResponse) {
...
//				{ "http://wager4.ebets247.com/", "301241", "BMW", "0", "0", "0", "None", "ET"}
				{ "http://wager1.playsports527.com/", "PREZ118", "MIKE", "0", "0", "0", "None", "ET"}
			};

			final Ebets247TDSportsProcessSite processSite = new Ebets247TDSportsProcessSite(TDSITES[0][0], TDSITES[0][1], TDSITES[0][2], false, true);
			...
			sre.setSpreadinputfirstone("7");
			sre.setSpreadjuiceplusminusfirstone("-");
			sre.setSpreadinputjuicefirstone("115");
			sre.setId(new Long(391));
			sre.setEventname("NCAAF #391 Texas A&M  +16 (-115) for Game");
			sre.setEventtype("spread");
			sre.setSport("ncaaflines"); 
			sre.setUserid(new Long(1));
			sre.setEventid(new Integer(391));
			sre.setEventid1(new Integer(391));
			sre.setEventid2(new Integer(392));
			sre.setRotationid(new Integer(391));
			sre.setWtype("1");
			sre.setAmount("100");
			...
			ae.setEventid(391);
			ae.setEventname("NCAAF #391 Texas A&M  +16 (-115) for Game");
			...
			ae.setSpread(new Float(7));
			ae.setSpreadid(new Long(391));
...
*/
	...
	public String loginToSite(String username, String password) throws BatchException {
		...
		MAP_DATA.put("ErrorURL", "//www.ebets247.com/?login-error");
		MAP_DATA.put("password", password);
		MAP_DATA.put("siteID", "83");
