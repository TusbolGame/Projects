 ...
 *
 */
public class Sports411TeamPackage extends SiteTeamPackage implements Serializable {
	...
	public String toString() {
		return "Sports411TeamPackage [tDate=" + tDate + ", tTime=" + tTime + ", spreadMax=" + spreadMax + ", totalMax="
				+ totalMax + ", mlMax=" + mlMax + ", hiddenData=" + hiddenData + ", betId=" + betId + ", gameTypeID="
				+ gameTypeID + ", idGame=" + idGame + ", idlg=" + idlg + ", idspt=" + idspt + ", parentIdg=" + parentIdg
				+ ", idCombinationGame=" + idCombinationGame + ", odds=" + odds + ", pitcher=" + pitcher + ", play="
				+ play + ", points=" + points + ", pointsTeaser=" + pointsTeaser + ", sport=" + sport + ", teamName="
				+ teamName + ", wagerType=" + wagerType + ", displayLine=" + displayLine + ", gameType=" + gameType
				+ ", details=" + details + ", lineType=" + lineType + ", lineStyle=" + lineStyle + ", categoryDesc="
				+ categoryDesc + ", leagueDesc=" + leagueDesc + "]\n " + super.toString();
	}
}