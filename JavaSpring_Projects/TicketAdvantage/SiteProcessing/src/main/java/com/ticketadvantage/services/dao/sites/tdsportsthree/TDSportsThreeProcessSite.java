 ...
 *
 */
public class TDSportsThreeProcessSite extends TDSportsProcessSite {
	private static final Logger LOGGER = Logger.getLogger(TDSportsThreeProcessSite.class);
	protected TDSportsThreeParser NSP = new TDSportsThreeParser();

	/**
	 * 
	 */
	public TDSportsThreeProcessSite(String host, String username, String password, boolean isMobile,
			boolean showRequestResponse) {
		super("TDSportsThree", host, username, password, isMobile, showRequestResponse);
		LOGGER.info("Entering TDSportsThreeProcessSite()");
		...
		NFL_LINES_NAME = new String[] { "NFL GAME LINES", "NFL PRESEASON" };
		...
		NCAAF_LINES_SPORT = new String[] { "NCAA FOOTBALL", "COLLEGE FOOTBALL" };
		NCAAF_LINES_NAME = new String[] { "NCAA FOOTBALL GAME LINES", "CFB GAME LINES" };
		NCAAF_FIRST_SPORT = new String[] { "NCAA FOOTBALL", "COLLEGE FOOTBALL" };
		NCAAF_FIRST_NAME = new String[] { "NCAA FOOTBALL 1ST HALF" };
		NCAAF_SECOND_SPORT = new String[] { "NCAA FOOTBALL", "COLLEGE FOOTBALL" };
		...
		LOGGER.info("Exiting TDSportsThreeProcessSite()");
	}
	...
	public static void main(String[] args) {
		try {
			...
			for (int i = 0; i < TDSITES.length; i++) {
				final TDSportsThreeProcessSite processSite = new TDSportsThreeProcessSite(TDSITES[i][0], TDSITES[i][1],
...
*/
				...
				tre.setTotalinputsecondone("8");
				tre.setTotalinputjuicefirstone("125");
				tre.setTotaljuiceplusminusfirstone("-");
				tre.setEventname("#914 New York Mets/Philadelphia Phillies u8.0 -125.0 for Game");
				tre.setEventtype("ml");
...
*/
	...
	public String loginToSite(String username, String password) throws BatchException {
		...
		// CreateSports.aspx
		xhtml = getSite(populateUrl("CreateSports.aspx?WT=35"));
		LOGGER.debug("HTML: " + xhtml);
