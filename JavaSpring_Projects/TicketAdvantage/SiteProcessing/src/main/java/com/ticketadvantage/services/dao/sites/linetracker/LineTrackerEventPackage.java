...
public class LineTrackerEventPackage extends SiteEventPackage implements Serializable {
	 ...
	 * 
	 */
	public LineTrackerEventPackage() {
		super();
	}
	...
	public String toString() {
		return "LineTrackerEventPackage [hiddenData=" + hiddenData + "] \n" + super.toString();
	}
}