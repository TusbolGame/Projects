 ...
 *
 */
public class TDSportsSevenProcessSite extends TDSportsProcessSite {
	private static final Logger LOGGER = Logger.getLogger(TDSportsSevenProcessSite.class);
	protected TDSportsSevenParser TDP = new TDSportsSevenParser();

	/**
	 * 
	 */
	public TDSportsSevenProcessSite(String host, String username, String password, boolean isMobile, boolean showRequestResponse) {
		super("TDSportsSeven", host, username, password, isMobile, showRequestResponse);
		LOGGER.info("Entering TDSportsSevenProcessSite()");
		...
		LOGGER.info("Exiting TDSportsSevenProcessSite()");
	}
	 ...
	 * @param password
	 */
	public TDSportsSevenProcessSite(String accountSoftware, String host, String username, String password, boolean isMobile, boolean showRequestResponse) {
...
//				{ "http://www.playsports527.com", "PREZ118", "MIKE", "0", "0", "0", "None", "ET"}
				{ "http://engine.betbig365.ag", "bt3059", "WARRIORS", "0", "0", "0", "None", "ET"}
			};
...
//			final TDSportsProcessSite processSite = new TDSportsProcessSite("http://www.1betvegas.com", "MM49", "LB", false, true);
			...
			final TDSportsSevenProcessSite processSite = new TDSportsSevenProcessSite(TDSITES[0][0], TDSITES[0][1], TDSITES[0][2], false, true);
...
*/
	...
	public String loginToSite(String username, String password) throws BatchException {
		...
		retValue = httpClientWrapper.getSitePage(populateUrl("CreateSports.aspx?WT=0&done"), null, headerValuePairs);
		xhtml = httpClientWrapper.getCookiesAndXhtml(retValue);
		LOGGER.debug("HTML: " + xhtml);
