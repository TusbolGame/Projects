 ...
 *
 */
public class AGSoftwareTeamPackage extends SiteTeamPackage implements Serializable {
	...
	public String toString() {
		return "AGSoftwareTeamPackage [tDate=" + tDate + ",\n tTime=" + tTime + ",\n hiddenData=" + hiddenData + "]\n" + super.toString();
	}
}