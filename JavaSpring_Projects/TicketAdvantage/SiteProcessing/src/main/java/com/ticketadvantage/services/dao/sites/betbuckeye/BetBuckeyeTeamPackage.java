...
public class BetBuckeyeTeamPackage extends SiteTeamPackage implements Serializable {
	...
	public String toString() {
		return "BetBuckeyeTeamPackage [tDate=" + tDate + ", tTime=" + tTime + ", spreadMax=" + spreadMax + ", totalMax="
