...
public class MasseyRatingsData {
	...
	public String toString() {
		return "MasseyRatingsData [dateString=" + dateString + ", dateOfGame=" + dateOfGame + ", team=" + team
				+ ", opponentTeam=" + opponentTeam + ", urlData=" + urlData + ", pointsfor=" + pointsfor
				+ ", pointsagainst=" + pointsagainst + ", score1=" + score1 + ", score2=" + score2 + ", spreadCovered="
				+ spreadCovered + ", totalCovered=" + totalCovered + ", gameComplete=" + gameComplete + ", awayGame="
				+ awayGame + "]";
	}
}