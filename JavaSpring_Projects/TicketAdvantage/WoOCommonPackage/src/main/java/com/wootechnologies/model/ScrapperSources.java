 ...
 */
@Entity
@Table (name="scrappersources")
@XmlRootElement()
@XmlAccessorType(XmlAccessType.NONE)
public class ScrapperSources implements Serializable {
	...
	public String toString() {
		return "ScrapperSources [scrapperid=" + scrapperid + ", accountid=" + accountid + "]";
	}
}