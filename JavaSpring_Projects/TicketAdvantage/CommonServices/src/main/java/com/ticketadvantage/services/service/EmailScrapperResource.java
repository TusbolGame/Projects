...
@Service
public class EmailScrapperResource {
	private static final Logger LOGGER = Logger.getLogger(EmailScrapperResource.class);
	 ...
	 * 
	 */
	public EmailScrapperResource() {
		super();
		LOGGER.debug("Entering EmailScrapperResrouce()");
		LOGGER.debug("Exiting EmailScrapperResrouce()");
	}
	...
	@Path("/id/{id}")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public EmailScrapper getScrapper(@PathParam("id") Long id) throws AppException {
		LOGGER.info("Entering getScrapper()");
		EmailScrapper retValue = null;

		try {
			// Find all groups
			retValue = scrapperDAO.findEmail(id);
		...
		LOGGER.debug("EmailScrapper: " + retValue);
	...
	@Path("/userid/{userid}")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Set<EmailScrapper> getScrappersForUser(@PathParam("userid") Long userid) throws AppException {
		LOGGER.info("Entering getScrappersForUser()");
		LOGGER.debug("userid: " + userid);
		Set<EmailScrapper> retValue = null;

		try {
			// Get all groups for user
			retValue = scrapperDAO.findScrappersByUserIdEmail(userid);
		} catch (AppException ae) {
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public EmailScrapper addScrapperForUser(EmailScrapper scrapper) throws AppException {
		LOGGER.info("Entering addScrapperForUser()");
		LOGGER.debug("EmailScrapper: " + scrapper);
		EmailScrapper retValue = null;

		try {
			retValue = scrapperDAO.persistEmail(scrapper);
		} catch (AppException ae) {
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public EmailScrapper updateScrapper(EmailScrapper scrapper) throws AppException {
		...
		try {
			// Update the scrapper
			EmailScrapper tempScrapper = scrapperDAO.findEmail(scrapper.getId());
			if (tempScrapper != null) {
				...
				retValue = scrapperDAO.mergeEmail(tempScrapper);
			} else {
				scrapperDAO.persistEmail(scrapper);
			}
		} catch (AppException ae) {
	...
	public void addSourceAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.addEmailSourceAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void addDestinationAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.addEmailDestinationAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void addMiddleAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.addEmailMiddleAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void addOrderAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.addEmailOrderAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void deleteSourceAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.deleteEmailSourceAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void deleteDestinationAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.deleteEmailDestinationAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void deleteMiddleAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.deleteEmailMiddleAccount(id, accountid);
		} catch (AppException ae) {
	...
	public void deleteOrderAccountForScrapper(@PathParam("id")Long id, @PathParam("accountid") Long accountid) throws AppException {
		...
		try {
			scrapperDAO.deleteEmailOrderAccount(id, accountid);
		} catch (AppException ae) {
